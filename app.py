...
def rate_lookup_handler():
    if request.method == 'OPTIONS':
        ...
        resp_obj = truckstop_integration.rate_lookup(params['equipment_group'], None, "TL", None, None, None, params['orig_city'], params['orig_state'], None, None, params['dest_city'],
